import { IGetRequestBody, IProjectUserData } from '../blocks'
import { UserFieldType, UserRole } from '../common.types'
 ...
 */
export interface IGetRuntimeFieldsWsUser extends IGetRequestBody {
  /**
